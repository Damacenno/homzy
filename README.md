...
| Página inicial | Login | Detalhes do serviço |
|---------------|-------|---------------------|
| ![Home](COLOQUE_AQUI_O_LINK_DA_IMAGEM_HOME) | ![Login](COLOQUE_AQUI_O_LINK_DA_IMAGEM_LOGIN) | ![Job Details](COLOQUE_AQUI_O_LINK_DA_IMAGEM_JOB_DETAILS) |
