...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <!-- Coluna da Esquerda: Fotos e Descrição -->
        <div class="lg:col-span-2 flex flex-col gap-6">
            ...
            <div class="border-4 border-black bg-white p-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <div
                    ...
                    @php
                        // Simulação de fotos. Substitua por $job->property->photos se houver
                        $fotos = [1, 2, 3, 4, 5]; 
                    @endphp

                    @foreach ($fotos as $index => $foto)
                        <div
                            class="relative group bg-gray-200 overflow-hidden border-1 border-black
        ...
        <!-- Coluna da Direita: Afazeres e Ação -->
        <div class="flex flex-col gap-6 h-full">

            <!-- Bloco da Lista de Afazeres (Tasks JSON - Estrutura Corrigida) -->
            <div class="border-4 border-black bg-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex-grow">
                    ...
                    @if(!empty($job->tasks) && is_array($job->tasks))
                        @foreach (array_slice($job->tasks, 0, 3) as $task)
                            <div
                                ...
                                <!-- Indicador de Nível de Importância -->
                ...
                <!-- Proprietário -->
                <div class="mt-8 pt-6 border-t-4 border-black flex items-center gap-4">
                    <div
            ...
            <div class="border-4 border-black bg-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                <div class="space-y-4">
                    ...
                    <!-- Lógica de Botão Baseada no Seu Código Original -->
                    @if (Auth::check())
    ...
    <!-- Script de Aplicação (Mantendo sua lógica original) -->
    <script>
